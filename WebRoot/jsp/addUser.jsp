   ...
   <table>
    <tr>
     ...
     <td>
      ...
      <input type="checkbox" class="interest" name="interest" value="篮球"/>篮球
      <input type="checkbox" class="interest" name="interest" value="游戏"/>游戏
      <input type="checkbox" class="interest" name="interest" value="游泳"/>游泳
      <input type="checkbox" class="interest" name="interest" value="唱歌"/>唱歌
     </td>
    </tr>
     <tr>
     <td>入职时间</td>
     <td><div id="timet"><input type="text" name="intime" class="laydate-icon"/></div></td>
    </tr>
     <tr>
     <td>部门</td>
     <td>
